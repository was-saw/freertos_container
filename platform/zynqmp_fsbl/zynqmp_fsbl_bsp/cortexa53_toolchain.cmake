...
set(TEMPLATE "zynqmp_fsbl")
set( CMAKE_HOST_NAME Linux)
set( CMAKE_C_FLAGS "${TOOLCHAIN_C_FLAGS} ${TOOLCHAIN_DEP_FLAGS} -specs=${CMAKE_SPECS_FILE} -Os -flto -ffat-lto-objects -DARMA53_64 -I${CMAKE_INCLUDE_PATH}" CACHE STRING "CFLAGS" FORCE)
set( CMAKE_CXX_FLAGS "${TOOLCHAIN_CXX_FLAGS} ${TOOLCHAIN_DEP_FLAGS} -specs=${CMAKE_SPECS_FILE} -Os -flto -ffat-lto-objects -DARMA53_64 -I${CMAKE_INCLUDE_PATH}" CACHE STRING "CXX FLAGS" FORCE)
set( CMAKE_ASM_FLAGS "${TOOLCHAIN_ASM_FLAGS} ${TOOLCHAIN_DEP_FLAGS} -specs=${CMAKE_SPECS_FILE} -Os -flto -ffat-lto-objects -DARMA53_64 -I${CMAKE_INCLUDE_PATH}" CACHE STRING "ASM FLAGS" FORCE)
