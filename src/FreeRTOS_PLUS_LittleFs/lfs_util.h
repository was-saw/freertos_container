...
#else
    return ((uint32_t)((uint8_t*)&a)[0] << 0) | ((uint32_t)((uint8_t*)&a)[1] << 8) |
...
static inline uint32_t lfs_frombe32(uint32_t a) {
    ...
    return a;
#else
    return ((uint32_t)((uint8_t*)&a)[0] << 24) | ((uint32_t)((uint8_t*)&a)[1] << 16) |
           ((uint32_t)((uint8_t*)&a)[2] << 8) | ((uint32_t)((uint8_t*)&a)[3] << 0);
#endif
}
